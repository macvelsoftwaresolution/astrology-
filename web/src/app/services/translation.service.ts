...
export const TA_TRANSLATIONS: Record<string, any> = {
  ...
  nav: {
    ...
    lmsSettings: "விளக்கவுரை & விதிமுறைகள்",
  ...
  lms: {
    ...
    seminars: "கருத்தரங்குகள் (Upcoming Seminars)",
    seminarsSub: "மாணவர்களுக்கான சிறப்பு இணையவழி கருத்தரங்குகள்",
    addSeminar: "+ புதிய கருத்தரங்கம் சேர்க்க",
    noSeminars: "கருத்தரங்குகள் ஏதுமில்லை.",
    liveClasses: "நேரடி வகுப்புகள் (Live Classes)",
    liveClassesSub: "Mobile App-ல் முகப்புப் பக்கத்தில் தோன்றும் நேரலை இணைப்புகள்",
    addLiveClass: "+ புதிய வகுப்பு சேர்க்க",
    noLiveClasses: "நேரடி வகுப்புகள் ஏதுமில்லை.",
    materials: "ஜோதிடக் குறிப்புகள் & பாடப் புத்தகங்கள் (PDF Notes)",
    materialsSub: "மாணவர்கள் பதிவிறக்கம் செய்யக்கூடிய குறிப்பேடுகள்",
    addMaterial: "+ புதிய குறிப்பு சேர்க்க",
    noMaterials: "குறிப்புகள் ஏதுமில்லை.",
    exams: "தேர்வுகள் (Exams & Quizzes)",
    examsSub: "மாணவர்களுக்கான தேர்வுகள்",
    addExam: "+ புதிய தேர்வு சேர்க்க",
    noExams: "தேர்வுகள் ஏதுமில்லை."
  },
  courier: {
...
export const EN_TRANSLATIONS: Record<string, any> = {
  ...
  nav: {
    ...
    matches: "Marriage Match",
    matrimony: "Matrimony Reg.",
    lms: "Learn & Course Studio",
    lmsSettings: "Intro & Guidelines",
  ...
  lms: {
    ...
    launchWizard: "Launch Course Studio",
    ...
    seminarsSub: "Special online webinars & seminars for students",
    addSeminar: "+ Add New Seminar",
    noSeminars: "No seminars available.",
    liveClasses: "Live Classes & Streaming",
    liveClassesSub: "Live class broadcast links shown on mobile app homepage",
    addLiveClass: "+ Add Live Class",
    noLiveClasses: "No live classes available.",
    materials: "PDF Notes & Study Materials",
    materialsSub: "Downloadable reference study guides and PDF books",
    addMaterial: "+ Add Study Material",
    noMaterials: "No study materials available.",
    exams: "Exams & Quizzes",
    examsSub: "Student assessment exams, evaluations and tests",
    addExam: "+ Create New Exam",
  ...
  services: {
    ...
    saveAstrologer: "Save Astrologer",
