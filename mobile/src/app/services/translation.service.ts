...
export const MOBILE_TA_TRANSLATIONS: Record<string, any> = {
  ...
  login: {
    title: "ஆருத்ரா",
    subtitle: "உள்நுழைவு",
    usernamePlaceholder: "மின்னஞ்சல் / பயனர் பெயர்",
  ...
  learn: {
    ...
    studentLoginDesc: "உங்கள் மாணவர் ஐடி (Student ID) மற்றும் கடவுச்சொல் உள்ளிட்டு வகுப்பைத் தொடரவும்.",
    userIdLabel: "மாணவர் ஐடி (Student ID) *",
...
export const MOBILE_EN_TRANSLATIONS: Record<string, any> = {
  ...
  learn: {
    ...
    studentLoginDesc: "Enter your Student ID and Password to access your course.",
